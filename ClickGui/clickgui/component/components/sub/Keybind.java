...
public class Keybind extends Component {
	...
	public void renderComponent() {
		...
		Client.instance.font30.drawString(binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKey())), (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset - 2) * 2 + 9, -1, false);
		GL11.glPopMatrix();
	}
