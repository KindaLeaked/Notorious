...
import Notorious.SessionChanger;
...
public class GuiAltManager extends GuiScreen {
	...
	public void actionPerformed(GuiButton button) throws IOException {
		...
		case 90: {
			...
			Minecraft.getMinecraft().session = new Session(Wrapper.generateRandomStringWithPrefix(), "", "", "mojang");
		...
		case 6969: {
			...
			if (clipboard.contains(":")) {
				String[] emailpass = clipboard.split(":");
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(6969, width / 2 / 2 / 2 + 140, 0, 120, 20, "Clipboard"));
