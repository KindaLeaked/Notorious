...
public class MoveUtils {
	...
	public static void setMoveSpeed(EventMotion eventMotion, double speed, String mode) {
		...
		case "event":
			if (mode != null) {
				eventMotion.setX(f * speed * Math.cos(Math.toRadians(playerYaw + 90))
						+ s * speed * Math.sin(Math.toRadians(playerYaw + 90)));
				eventMotion.setZ(f * speed * Math.sin(Math.toRadians(playerYaw + 90))
						- s * speed * Math.cos(Math.toRadians(playerYaw + 90)));
			}
			break;
		case "default":
			if (mode != null) {
				mc.thePlayer.motionX = f * speed * Math.cos(Math.toRadians(playerYaw + 90))
						+ s * speed * Math.sin(Math.toRadians(playerYaw + 90));
				mc.thePlayer.motionZ = f * speed * Math.sin(Math.toRadians(playerYaw + 90))
						- s * speed * Math.cos(Math.toRadians(playerYaw + 90));
			}
			break;
		}
		...
		if (forward == 0.0 && strafe == 0.0) {
			...
			if (e != null) {
				e.setX(forward * speed * Math.cos(Math.toRadians(yaw + 90.0f))
						+ strafe * speed * Math.sin(Math.toRadians(yaw + 91.50F)));
				e.setZ(forward * speed * Math.sin(Math.toRadians(yaw + 90.0f))
						- strafe * speed * Math.cos(Math.toRadians(yaw + 90.25F)));
			} else {
	...
	public static void setMotion(EventMotion e, double baseMovementSpeed, int i) {
		...
		if (forward == 0.0 && strafe == 0.0) {
			...
			if (e != null) {
				e.setX(forward * baseMovementSpeed * Math.cos(Math.toRadians(yaw + 90.0f))
						+ strafe * baseMovementSpeed * Math.sin(Math.toRadians(yaw + 91.50F)));
				e.setZ(forward * baseMovementSpeed * Math.sin(Math.toRadians(yaw + 90.0f))
						- strafe * baseMovementSpeed * Math.cos(Math.toRadians(yaw + 90.25F)));
			} else {
				mc.thePlayer.motionX = forward * baseMovementSpeed * Math.cos(Math.toRadians(yaw + 90.0f))
						+ strafe * baseMovementSpeed * Math.sin(Math.toRadians(yaw + 91.50F));
				mc.thePlayer.motionZ = forward * baseMovementSpeed * Math.sin(Math.toRadians(yaw + 90.0f))
						- strafe * baseMovementSpeed * Math.cos(Math.toRadians(yaw + 90.25F));
			}
		}
	}
	...
	public static boolean isBlockUnderneath(BlockPos pos) {
		for (int k = 0; k < pos.getY() + 1; k++) {
			if (mc.theWorld.getBlockState(new BlockPos(pos.getX(), k, pos.getZ())).getBlock()
	...
	public static void setMotion(EventMotion em, double speed, double strafeSpeed) {
		...
		if (forward == 0.0 && strafe == 0.0) {
			...
			if (em != null) {
				em.setX(forward * speed * Math.cos(Math.toRadians(yaw + 90f))
						+ strafe * speed * Math.sin(Math.toRadians(yaw + 90f)));
				em.setZ(forward * speed * Math.sin(Math.toRadians(yaw + 90f))
						- strafe * speed * Math.cos(Math.toRadians(yaw + 90f)));
			} else {
				mc.thePlayer.motionX = forward * speed * Math.cos(Math.toRadians(yaw + 90f))
						+ strafe * speed * Math.sin(Math.toRadians(yaw + 90f));
				mc.thePlayer.motionZ = forward * speed * Math.sin(Math.toRadians(yaw + 90f))
						- strafe * speed * Math.cos(Math.toRadians(yaw + 90f));
			}
		}
	}
